      ...
      <div className=" mx-auto max-w-screen-xl px-5 lg:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 max-w-xs">
              Discover hidden gems and unique local experiences. Connect with authentic places that give your city its soul.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Local Shops</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Cafés & Restaurants</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Art & Experiences</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Events & Services</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Hidden Gems Map</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Xplore. All rights reserved.
          </p>
